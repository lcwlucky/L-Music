...
<template>
  <div class="player" v-show="playList.length">
        ...
        <div class="bottom">
          ...
          <div class="progress-wrapper">
            ...
            <div class="progress-bar-wrapper">
              <progress-bar :percent="percent" @percentChange="onProgressBarChangeByUser"></progress-bar>
            </div>
    ...
    <audio ref="audio" @play="ready" @error="error" @timeupdate="updateTime" @ended="end"/>
  ...
  export default {
    ...
    watch: {
      ...
      currentSong (newSong, oldSong) {
        ...
        if(this.currentLyric) { //如果当前有歌词解析对象，先停止
