<template>
  <div class="search">
      ...
      <scroll ref="shortcut" class="shortcut" :data="shortcut">
        <div>
          ...
          <div class="search-history" v-show="searchHistory.length">
            ...
            <search-list :searches="searchHistory" @select="selectHistory" @delete="delectOneHistory"></search-list>
          </div>
        </div>
      </scroll>
    </div>
    ...
    <confirm @confirm="confirmClear" text="是否清空搜索记录" ref="confirm"></confirm>
